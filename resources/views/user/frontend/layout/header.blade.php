    ...
    <div class="sticky-wrapper">
        <div class="container-fluid">
            ...
            <div class="l-header__logo d-flex">
                <a class="logoItem" href="{{ lang_route('user.frontend.index') }}" rel="noopener noreferrer">
                ...
                <div class="navWrap">
                    ...
                    <ul class="mainMenu">
                        ...
                        <li class="mainMenu__item mainMenu__item--parent js-submenu-switcher">
                            ...
                            <ul class="subMenu">
                                <li class="subMenu__item"><a href="{{ lang_route('user.frontend.traffic') }}" class="menuText"><span>{{ __('layout.navigation.nav3-1') }}</span></a></li>
                                <li class="subMenu__item"><a href="{{ lang_route('user.frontend.traffic') }}#route" class="menuText"><span>{{ __('layout.navigation.nav3-2') }}</span></a></li>
                            </ul>
                        </li>
                        <li class="mainMenu__item mainMenu__item--parent js-submenu-switcher">
                            <div class="menuText {{ request()->routeIs('user.frontend.about*') ? 'is-current' : '' }}"><span>{{ __('layout.navigation.nav4') }}</span></div>
                            <ul class="subMenu">
                                <li class="subMenu__item"><a href="{{ lang_route('user.frontend.about.overview.list') }}" class="menuText"><span>{{ __('layout.navigation.nav4-4') }}</span></a></li>
                                ...
                                <li class="subMenu__item"><a href="{{ lang_route('user.frontend.about.vi') }}" class="menuText"><span>{{ __('layout.navigation.nav4-3') }}</span></a></li>
                                <li class="subMenu__item"><a href="{{ lang_route('user.frontend.style') }}#guide" class="menuText"><span>{{ __('layout.navigation.nav7-2') }}</span></a></li>
                            </ul>
                        </li>
                        <li class="mainMenu__item mainMenu__item--parent js-submenu-switcher">
                        ...
                        <li class="mainMenu__item mainMenu__item--parent js-submenu-switcher">
                            ...
                            <ul class="subMenu">
                                <li class="subMenu__item"><a href="{{ lang_route('user.frontend.style') }}" class="menuText"><span>{{ __('layout.navigation.nav7-1') }}</span></a></li>
                                <li class="subMenu__item"><a href="{{ lang_route('user.frontend.style') }}#documentary" class="menuText"><span>{{ __('layout.navigation.nav7-3') }}</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
