...
return new class extends Migration
{
    ...
    {
        Schema::create('brand_content_links', function (Blueprint $table) {
            $table->id();
            $table
                ->foreignId('brand_content_id')
                ->constrained('brand_contents', 'id', 'b_content_links_content_id_fk')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('brand_content_links');
    }
};
