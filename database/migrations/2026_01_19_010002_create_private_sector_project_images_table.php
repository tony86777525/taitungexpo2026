...
return new class extends Migration
{
    ...
    {
        Schema::create('private_sector_project_images', function (Blueprint $table) {
            $table->id();
            $table
                ->foreignId('private_sector_project_id')
                ->constrained('private_sector_projects')
                ->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('private_sector_project_images');
    }
};
