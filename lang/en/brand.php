...
return [
    'page-title' => 'Brand Licensing',
    'intro' => [
        'paragraph1' => "To extend the application and social impact of the Taitung Expo brand identity, the Taitung County Government has launched the <span class='highlight'>Brand Trademark Licensing Program</span>, establishing a clear and open collaboration mechanism. Brands, manufacturers, distributors, enterprises, and creators are invited to participate, transforming Taitung's aesthetics, culture, and sustainability values into everyday products, services, and experiences.",
    ...
    'event' => [
        ...
        'event2' => [
            'title' => 'Taitung Expo Main Venue Shop',
            'topic1' => [
                'date' => 'Date: July 3 (Fri) – August 20 (Thu), 2026',
                'location' => 'Venue: Taitung County Stadium (No.124, Guilin N. Rd., Taitung City, Taitung County)',
            ],
            'buttons' => [
                'btnText1' => 'MORE'
            ]
        ...
        'event3' => [
            ...
            'topic2' => [
                'topic' => 'Taipei Metro Micro Exhibition',
                'date' => 'Date: June 8 (Mon) – June 14 (Sun), 2026',
                'location' => 'Venue: Ximen Station, Taipei Metro',
            ],
            'buttons' => [
                'btnText1' => 'MORE'
            ]
    ...
    'list' => [
        'filters' => [
            'filterTxt1' => 'ALL',
            'filterTxt2' => 'Slow Sips',
            'filterTxt3' => 'Slow Food',
            'filterTxt4' => 'Slow Craft',
            'filterTxt5' => 'Slow Living',
        ]
    ]
];
